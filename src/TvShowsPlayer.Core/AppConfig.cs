...
public sealed class AppConfig
{
    ...
    // Экран для показа канала. Проигрывателю уходит НОМЕР (только его он и понимает),
    // а имя (\\.\DISPLAY2) хранится, чтобы пересчитать номер, если мониторы
    // переподключили или поменяли местами.
